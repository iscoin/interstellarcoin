...
uint256 hashGenesisBlock("0x75ca207cf553fcdc8a586ca3d952b4e1ab59993d5953a7bef05da8bd68d705df");
...
const string strMessageMagic = "interstellarcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 128 * 24 * 60 * 60; // interstellarcoin: 128 days
static const int64 nTargetSpacing = 256; // interstellarcoin: 4 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal interstellarcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "interstellarcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0eeb246fc2e1fe92b63c6de55d6b0c7a2c66adf87ce50c3e830c174d8423ae44");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "All I ever did was program and now look at this mess...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1426776500; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2864881;

        if (fTestNet)
        {
            block.nTime    = 1426768487;
            block.nNonce   = 472470;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe8831c49abe78899e8f44b3e4d1b92bdd50a16a41dd02b03246c9c8edcc06d74"));
